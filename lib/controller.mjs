...
import ServiceProviderWebservice    from "./serviceproviderwebservice.mjs";
...
export default class Controller extends Reporter(EventEmitter) {
    ...
    init() {
        this.serviceproviderwebservice = new ServiceProviderWebservice();
        this.serviceproviderwebservice.start();
/*
