...
export class SelfSovereignIdentityMeta extends MetaClass {
    ...
    initiateInstance() {
        ...
        this.collection("credentials",  Directory, { autocomplete: true, autoinit: true });
        this.collection("contacts",     Directory, { autocomplete: true, autoinit: true });
        this.collection("channels",     Directory, { autocomplete: true, autoinit: true });
        this.collection("agents",       Directory, { autocomplete: true, autoinit: true });
        this.collection("devices",      Directory, { autocomplete: true, autoinit: true });
        this.collection("collections",  Directory, { autocomplete: true, autoinit: true });
        this.collection("repositories", Directory, { autocomplete: true, autoinit: true });
        this.collection("apps",         Directory, { autocomplete: false, autoinit: false });
        this.collection("aliases",      Directory, { autocomplete: true, autoinit: true });
        this.collection("test",         Directory, { autocomplete: true });
        this.collection("mediathek",    SSIMediaDirectory, { autocomplete: true, autoinit: true });
...
export default class SelfSovereignIdentity extends ThoregonEntity() {
    ...
    get apiKey() {
        return this._apiKey ?? this._ssiagent?.anchor;
    }
