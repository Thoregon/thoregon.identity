...
export default class IdentityResolver /*extends EventEmitter*/ {
    ...
    async getItem(group, name) {
        throw universe.ErrNotImplemented('IdentityResolver.getItem');
    }

    async setItem(group, name, item) {
        throw universe.ErrNotImplemented('IdentityResolver.setItem');
    }

    async removeItem(group, name) {
        throw universe.ErrNotImplemented('IdentityResolver.removeItem');
    }
    ...
    async getItemNames(group) {
        throw universe.ErrNotImplemented('IdentityResolver.getItemNames');
    }
